...
const date = new Date();
  const currentTime = date.toLocaleDateString(); //or =date.getFullYear() +" -" +(d.getMonth()+1) + "-" +d.getDate();
              ...
              <div className="row">
                <div className="col-9">
                  <div className="d-flex align-items-center align-self-start">
                    ...
                    <p className="text-success ml-2 mb-0 font-weight-medium"style={{width:"50px",fontSize:"30px"}}>{categories?.length}</p>
                  </div>
                </div>
              ...
              <div className="row">
                <div className="col-9">
                  <div className="d-flex align-items-center align-self-start">
                    ...
                    <p className="text-success ml-2 mb-0 font-weight-medium"style={{width:"50px",fontSize:"30px"}}>{subcategories?.length}</p>
                  </div>
                </div>
              ...
              <div className="row" style={{marginleft:"10px"}} >
                <div className="col-9">
                  <div className="d-flex align-items-center align-self-start">
                    ...
                    <p className="text-success ml-2 mb-0 font-weight-medium"style={{width:"50px",fontSize:"30px"}}>{products?.length}</p>
                  </div>
                </div>
              ...
              <div className="row" style={{marginTop:"10px"}}>
                <div className="col-9">
                  <div className="d-flex align-items-center align-self-start">
                    ...
                    <p className="text-success ml-2 mb-0 font-weight-medium"style={{width:"50px",fontSize:"20px"}}>{time}</p>
                  </div>
                </div>
